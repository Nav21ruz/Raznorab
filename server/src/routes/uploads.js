...
// Без лимита вошедший пользователь мог бы штамповать подписанные ссылки без
// ограничений и заливать в бакет сколько угодно файлов, раздувая счёт за хранилище.
const signLimiter = rateLimit({
  windowMs: 15 * 60 * 1000,
  limit: 60,
  standardHeaders: true,
  legacyHeaders: false,
  message: { error: 'Слишком много запросов на загрузку фото. Попробуйте позже.' },
})
...
uploadsRouter.post('/sign', signLimiter, asyncRoute(async (req, res) => {
